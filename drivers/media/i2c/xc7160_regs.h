...
static const struct regval xc7160_2160p_regs[] = {
    //Initial_start
    //isp_size:3840*2160
    {0xfffd,0x80},
    {0xfffe,0x50},
...
static const struct regval xc7160_1080p_regs[] = {
    //Initial_start
    {0xfffd,0x80},
    {0xfffe,0x50},
    {0x001c,0xff},
...
static const struct regval xc7160_4k_25fps_regs[] = {
    //Initial_start
    //isp_size:3840*2160@25fps
    //Initial_start
...
static const struct regval xc7160_4k_t20210715_regs[] = {
    //xc7160_sc8238_3840*2160_25fps
    {0xfffd,0x80}, 
    {0xfffe,0x50}, 
    {0x001c,0xff}, 
    {0x001d,0xff}, 
    ...
    //patch_start                   
    //以下patch setting需根据实际需求或先前参数添加进
...
static const struct regval xc7160_1080p_t20210720_regs[] = {
    //xc7160_sc8238_1920x1080_60fps
    {0xfffd,0x80},
    {0xfffe,0x50},
    {0x001c,0xff},
    {0x001d,0xff},
    ...
    {0x0212,0x1},  // enable switch avg stable thr
    {0x0215,0x28},  // global avg diff thr normal 
    {0x0217,0x48},  // global avg diff thr for AF
    {0x0219,0x80},  // global all diff thr normal,}look in {0xd8
    {0x021b,0xff},  // global all diff thr for AF,}look in {0xd8
    //{0x1b6,0x28,}  //avgdiff_en  enable AE threshold    
    //////////////////// DEBUG	 /////////////////////   
    //{0x209,0x01,}	 //b2d speed limit                   
    {0x020b,0x40},   //b2d stable buff                           
    {0x020d,0x3},   //b2d speed limit max cnt,} 0 means disable   
    {0x0220,0x0},                                                
    {0x0221,0xff},   //HistLimitDarkenMaxVal,}according {0x27(15%  
    {0x0144,0x01},
    {0x0145,0x01},
    /////////////////////////////////////////////////////
    ///////////////////   AE START	END   ///////////////
    ...
    {0x400b,0x00},  //debug        
    {0xfffe,0x14},
    {0x0024,0x0 },  //bDebugEnable; /**< BOOL: Debug enable */
    {0x0025,0x00},
    {0x0027,0x07},  //nDebugAFMode; /**< BOOL: AF Debug enable */
    {0x002d,0x01},   //bISP0AFEnable;	/**< BOOL: AF enable */
    {0x02e0,0x01} ,  //nAFMode; /**< 0. AF_SNAPSHOT,} 1,} AF_VIDEOSERVO */
    {0x02e1,0x00} ,  // bAutoContrastThr;
    {0x02e2,0x01} ,  //bAFActive; /**< current AF status is active or not	*/                                                                    
                                                                            
    /////////////////////////////////////////////////////                      
    /////////////////////motor driver////////////////////                      
                                                                            
    {0x02e7,0x1e},   //frame rate   
    {0x045b,0x01},   // 8bit addr 16 bits value
    //{0x0474,0x09,} //focus_i2c_option
    {0x0475,0x18},   // slave ID
    {0x0476,0xc0},   // motor set : addr
    {0x0466,0x00},  
    {0x0467,0x3a},   // motor used time ms                   
    {0x0368,0x01},// previous move
    //{0x369,0xff,}                                                             
                                                                            
    {0x030c,0x08},//over peak ratio
    {0x02e8,0x01},
    {0x02e9,0x00},//base step
    {0x02ea,0xc},//coarse min step ratio
    {0x02eb,0x14},//coarse step ratio
    {0x02ec,0xa},//FINE step
    {0x02ed,0x8},//FINE step
    {0x02fe,0x00},//compare-coarse
    {0x02ff,0x30},
    {0x0300,0x00},//compare-coarse
    {0x0301,0x30},
    {0x0302,0x00},//compare-fine
    {0x0303,0x18},
    {0x0304,0x00},//compare-fine
    {0x0305,0x28},
    {0x047c,0x00},// DAC MIN
    {0x047d,0x40},// DAC MIN
    {0x047e,0x02},// DAC MAX
    {0x047f,0x40},
    {0x030e,0x02}, //failure choose          
    {0x0539,0x18}, //n AF Stat Ratio         
    {0x05f0,0x00},//HW max low thrshold
    {0x05f1,0x10},        
    {0x05ef,0x18},  //HistDvalue MAX
    ...
    {0x05a8,0x01}, 		 //detect
    {0x05a9,0x00},
    {0x0310,0x18},	 // detect last mean change 
    {0x0311,0x14},	 // detect last mean diff-value change
    {0x0312,0x18}, 		 //detect histogram difference
    {0x030f,0x80}, 		 // contrast change ratio  U.6
    {0x0314,0xc0},
    ///////////////////   AF START END	 ///////////////
...
static const struct regval xc7160_1080p_t20210827_regs[] = {
    //xc7160_sc8238_1920x1080_30fps 1264MHz
    {0xfffd,0x80},                                                                                   
    {0xfffe,0x50},                                                                                   
    {0x001c,0xff},                                                                                   
    {0x001d,0xff},                                                                                   
...
//Initial_end 
  ...
  //AWB      }                                                                                   
    ...
    {0x0268,0x00},                                                                                  
    {0x0269,0xa7}, //awb_color2                                                                     
    {0x026a,0x80}, //awb_shift_R 加大偏蓝，减小偏黄                                                 
    {0x026b,0x80}, //awb_shift_B 加大偏红，减小偏绿                                                 
...
static const struct regval xc7160_1080p_t20210831_regs[] = {                                              
  //xc7160_sc8238_1920x1080_30fps 1152MHz                                             
  {0xfffd,0x80},                                                       
  {0xfffe,0x50},                                                       
  {0x001c,0xff},                                                       
  {0x001d,0xff},                                                       
...
//以下patch setting需根据实际需求或先前参数添加进来  
  ...
  //CIP      }                                                                      
  {0xfffe,0x30},                                                                     
  {0x0f00,0x23}, //bit[7:4] noise_y_slp bit[3:0] Lsharp                              
  {0x0f02,0x00}, //noise_list0                                                       
  {0x0f03,0x00},                                                                     
  {0x0f04,0x00},                                                                     
  {0x0f05,0x00},                                                                     
...
static const struct regval sensor_25fps_initial_regs[] = {	
	//sc8238_3840*2160_25fps
    {0x0103,0x01}, //复位后为0
    {0x0100,0x00}, 
    {0x36e9,0x80}, 
    {0x36f9,0x80}, 
...
static const struct regval sensor_25fps_4k_initial_regs[] = {
    {0x0103,0x01},  
    {0x0100,0x00},  
    {0x36e9,0x80},  
    {0x36f9,0x80},  
...
static const struct regval sensor_60fps_1080p_initial_regs[] = {
    {0x0103,0x01},
    {0x0100,0x00},
    {0x36e9,0x80},
    {0x36f9,0x80},
...
static const struct regval sensor_30fps_t20210827_initial_regs[] = {
	{0x0103,0x01},                                                                                      
    {0x0100,0x00},                                                                                      
   ...
   //1214, 0x5011,0x85? TODO                                                                          
    ...
    {0x394f,0x90},                                                                                      
    {0x3981,0x70},                                                                                      
    {0x3984,0x20},//blc trigger，alpha trigger，解决blc逻辑点起始点闪烁问题                             
    {0x3987,0x08},                                                                                      
   ...
   //0x303f,0x01,                                                                                     
   //0x3030,0x01,                                                                                     
   //0x36e9,0x53,//vco=27/4*5*3*7=708.75                                                              
   //0x36ea,0x39,                                                                                     
   //0x36eb,0x06,                                                                                     
   //0x36ec,0x05,//mipiclk=vco; mipipclk=vco/5/2=70.875                                               
   //0x36ed,0x24,                                                                                     
   //0x4837,0x1c,                                                                                     
   //0x36f9,0x57,//vco=27/4*2*4*3*7=1134                                                              
   //0x36fa,0x39,                                                                                     
   //0x36fb,0x13,//sclk=vco/2/4=141.75                                                                
   //0x36fc,0x10,//countclk=vco/2=567                                                                 
   //0x36fd,0x14,                                                                                     
   //0x320c,0x08,                                                                                     
   //0x320d,0x34,//2100                                                                               
   //0x320e,0x08,                                                                                     
   ...
   //0x3031,0x0a,                                                                                     
   //0x3037,0x20,                                                                                     
   //0x3306,0xa8,//[hl,of][84,cc]                                                                     
   //0x330a,0x01,                                                                                     
   //0x330b,0x48,//[ns,of][11f,16c]                                                                   
   ...
   //init                                                                                             
    ...
    {0x320c,0x08},                                                                                      
    {0x320d,0x20},                                                                                      
   //hts=2080, vts=2250, pclk=140.4, framerate=30, countclk=561.6, mipiclk=702                        
   //24/4*4*1.5*1.5*13=702                                                                            
   //24/2.5*2*1.5*1.5*13=561.6                                                                        
   //0x36e9,0x51,//vco=24/4*4*1.5*1.5*13=702                                                          
    {0x36ea,0x73},                                                                                      
    {0x36eb,0x04},                                                                                      
    {0x36ec,0x05},//mipiclk=vco; mipipclk=vco/5/2=70.875                                                
    {0x36ed,0x14},                                                                                      
    {0x4837,0x1c},                                                                                      
   //0x36f9,0x35,//vco=24/2.5*2*1.5*1.5*13=561.6                                                      
    {0x36fa,0x73},                                                                                      
    {0x36fb,0x11},//sclk=vco/2/2=140.4                                                                  
    {0x36fc,0x00},//countclk=vco=561.6                                                                  
    {0x36fd,0x07},//hl-->add cp current                                                                 
   //0x3306,0xa8,//[hl,of][84,c2]                                                                     
   //0x330a,0x01,                                                                                     
   //0x330b,0x48,//[ns,of][11f,162]                                                                   
                                                                                                        
    {0x3208,0x0f},//3848x2168                                                                           
    {0x3209,0x08},                                                                                      
    {0x320a,0x08},                                                                                      
    {0x320b,0x78},                                                                                      
    {0x320c,0x08},                                                                                      
   ...
   //20190520                                                                                         
    {0x3632,0xa8},//pump driver, Cross-striated yield                                                   
                                                                                  
                                                                                  
    {0x36e9,0x51},                                                                                      
    {0x36f9,0x35},                                                                                      
                                                                                  
    {0x301f,0x2e},//setting id                                                                          
                                                                                  
    {0x0100,0x01}, // 561.6M count_clk 140.4M sysclk                                                    

    {REG_NULL, 0x00},
};

static const struct regval sensor_30fps_t20210831_initial_regs[] = {
  {0x0103,0x01},                         
  {0x0100,0x00},                         
...
/*
    This regs array could initial isp register setting and sensor register setting. 
    Sensor register setting initial are written by isp module of camera not CPU platform
*/

static const struct regval xc7160_isp_sensor_4k_25fps_regs[] ={
    {0xfffd,0x80},
    {0xfffe,0x50},
    {0x001c,0xff},
    {0x001d,0xff},
...
static const struct regval xc7160_1080p_isp_sensor_cheng_gong_regs[] = {
	{0xfffd,0x80},
	{0xfffe,0x50},
	{0x001c,0xff},
	{0x001d,0xff},
...
static const struct regval xc7160_isp_sensor_1080p_25fps_o_regs[] = {
    {0xfffd,0x80},
    {0xfffe,0x50},
    {0x001c,0xff},
    {0x001d,0xff},
    ...
    {0x400b,0x00},  //debug        
    {0xfffe,0x14},
    {0x0024,0x00},  //bDebugEnable; /**< BOOL: Debug enable */
    {0x0025,0x00},
    {0x0027,0x07},  //nDebugAFMode; /**< BOOL: AF Debug enable */
    {0x002d,0x01},   //bISP0AFEnable;	/**< BOOL: AF enable */
    {0x02e0,0x01},  //nAFMode; /**< 0{ AF_SNAPSHOT}, 1}, AF_VIDEOSERVO */
    ...
    {0x02e8,0x01},
    {0x02e9,0x00},//base step
    {0x02ea,0x0c},//coarse min step ratio
    {0x02eb,0x14},//coarse step ratio
    {0x02ec,0x0a},//FINE step
    {0x02ed,0x08},//FINE step
    {0x02fe,0x00},//compare-coarse
    {0x02ff,0x30},
    {0x0300,0x00},//compare-coarse
    {0x0301,0x30},
    ...
    // lasthist change ratio U6                                              
    {0x02f2,0x00},
    {0x02f3,0x12},
    {0x02f4,0x00},
    {0x02f5,0x16},
                                                                            
    // previous hist change ratio U6                                          
    {0x02f6,0x00},
    {0x02f7,0x06},
    {0x02f8,0x00},
    {0x02f9,0x08},
    ...
    // histdiff-value change ratio U6                                        
    {0x02fa,0x00},
    {0x02fb,0x00},
    {0x02fc,0x00},
    {0x02fd,0x00},
                                                                            
    // histmean change ratio U6                                              
    {0x0308,0x1c},
    ...
    {0x0311,0x14},	 // detect last mean diff-value change
    {0x0312,0x18}, 		 //detect histogram difference
    {0x030f,0x80}, 		 // contrast change ratio  U6
    {0x0314,0xc0},
    ///////////////////   AF START END	 ///////////////
